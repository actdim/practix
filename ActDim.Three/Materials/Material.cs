...
namespace ActDim.Three.Materials
{
    ...
    public class Material : Element, IMaterial
    {
        ...
        /// <summary>
        /// User-defined clipping planes specified as ActDim.Three.Plane objects in world space. These planes apply to the objects this material is attached to. Points in space whose signed distance to the plane is negative are clipped (not rendered).
        /// </summary>
