...
namespace ActDim.Practix.Abstractions.Compression
{
    public interface ICompressionManager
    {
        ...
        /// <exception cref="DataFormatException">The entry is missing from the archive or is corrupt and cannot be read. -or- The entry has been compressed using a compression method that is not supported.</exception>
