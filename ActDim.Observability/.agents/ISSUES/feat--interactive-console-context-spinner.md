...
## Description
Create a dedicated project/package (`ActDim.Observability.Console` or `ActDim.Practix.ConsoleUI`) that consumes `CallContext` ambient properties (`Status`, `Progress`, `Icon`, `Tags`) and provides a rich interactive console UI.
