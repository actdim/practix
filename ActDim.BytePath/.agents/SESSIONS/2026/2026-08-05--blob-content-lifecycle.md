...
summary: >
  ...
  instead of being dropped, Size is read from the store and library-owned, all deletion paths now
  remove the stored bytes, and the data-store write surface lost CreateAsync and the append offset.
---
