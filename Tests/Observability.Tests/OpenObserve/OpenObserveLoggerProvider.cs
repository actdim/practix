...
{
    public sealed class OpenObserveLoggerProvider : ILoggerProvider, ISupportExternalScope
    {
        private readonly OpenObserveClient _client;
        ...
        public OpenObserveLoggerProvider(OpenObserveClient client, IAmbientContext? ambientContext = null)
        {
        ...
        {
            return new OpenObserveLogger(this, categoryName);
        }
        ...
        private sealed class OpenObserveLogger : ILogger
        {
            private readonly OpenObserveLoggerProvider _provider;
            private readonly string _categoryName;

            public OpenObserveLogger(OpenObserveLoggerProvider provider, string categoryName)
            {
                _provider = provider;
