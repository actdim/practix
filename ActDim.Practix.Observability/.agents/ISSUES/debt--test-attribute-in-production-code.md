...
## Description
`EventObservabilityLoggerFactory.ResolveProviderAlias` resolves provider aliases by comparing the attribute type name against a hard-coded list that includes a test type ([EventObservabilityLoggerFactory.cs:93](../../ActDim.Practix.Observability/EventObservabilityLoggerFactory.cs#L93)):
