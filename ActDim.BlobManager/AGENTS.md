...
- Namespace and assembly: `ActDim.BlobManager`; target `net10.0`; `Nullable` disabled
...
- `InternalsVisibleTo("ActDim.BlobManager.Tests")` — tests construct internals directly
