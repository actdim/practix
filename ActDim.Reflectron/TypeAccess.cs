...
namespace ActDim.Reflectron
{
    ...
    /// </summary>
    public static class TypeAccess<T>
    {
        /// <summary>
        /// Gets a member by it's expression usage.
        ...
        {
            return TypeAccess.GetPropertyGetter<T, TProperty>(propInfo);
        }

        public static Func<T, TField> GetFieldGetter<TField>(FieldInfo fieldInfo)
        {
            return TypeAccess.GetFieldGetter<T, TField>(fieldInfo);
        }

        public static Func<T, TProperty> GetPropertyGetter<TProperty>(string name)
        {
            return TypeAccess.GetPropertyGetter<T, TProperty>(name);
        }
        ...
        {
            return TypeAccess.GetFieldGetter<T, TField>(name);
        }
        ...
        {
            return TypeAccess.GetStaticMethodCaller<T, TDelegate>(name);
        }

        public static TDelegate GetMethodCaller<TDelegate>(string name)
        {
            return TypeAccess.GetMethodCaller<T, TDelegate>(name);
        }
    }
}
